...
(** Lega il successore su [Positive] col successore su [nat], 
attraverso la funzione di conversione [pos2Nat]. *)
Definition P_pos2Nat_nat2Pos (p: PositiveNum.Positive)  :=
  pos2Nat (PositiveNum.succ p) = S (pos2Nat p).

(** *** Passo base e passi induttivi per [pos2Nat_nat2Pos] *)
